...
<body bgcolor="white" leftmargin="0" topmargin="0" marginwidth="0"
	...
	<div align="center">
		...
		<form name="form1" method="post" action="faq_edit">
			<table width="600" border="1" cellspacing="0" bordercolordark="white"
				...
				<input type="hidden" name="adminNo" value="${authAdmin.no }">
					<tr>
						...
						<td width="500" height="20" bgcolor="#F2F2F2">&nbsp 
						<input type="text" name="title" value="${vo.title}" size="67">
						</td>
					</tr>
					<tr>
						<td width="100" height="20" bgcolor="#CCCCCC" align="center">
						...
						<td width="500" height="20" bgcolor="#F2F2F2">&nbsp 
						<textarea name="content" rows="7" cols="65">${vo.content }</textarea>
						</td>
					</tr>
				</c:forEach>
			</table>
			...
			<table width="600" border="0" cellspacing="0" cellpadding="7">
				<tr>
					<td align="center"><input type="submit" value="등 록 하 기">
						&nbsp;&nbsp <a href="faq"><input type="button" value="이 전 화 면"></a>
					</td>
				</tr>
			</table>
